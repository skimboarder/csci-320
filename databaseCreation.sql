...
CREATE TABLE has_customization ( custom_id integer NOT NULL PRIMARY KEY REFERENCES customization_options(custom_id), sale_id integer NOT NULL PRIMARY KEY REFERENCES sale(sale_id), PRIMARY KEY(custom_id, sale_id) );
